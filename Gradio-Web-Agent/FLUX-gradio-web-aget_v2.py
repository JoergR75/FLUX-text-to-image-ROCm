#!/usr/bin/env python3
"""
FLUX text-to-image agent with simple web prompt agent UI (Gradio) - AMD ROCm optimized

Features:
 - Multi-GPU/ROCm optimizations
...
def build_ui():
    with gr.Blocks(title="FLUX Text-to-Image Web-Agent (ROCm optimized)") as demo:
        gr.Markdown("# [![GitHub](https://img.shields.io/badge/GitHub-FLUX--text--to--image--ROCm-181717?logo=github&style=flat-square)](https://github.com/JoergR75/FLUX-text-to-image-ROCm/tree/main/Gradio-Web-Agent)[![FLUX](https://img.shields.io/badge/FLUX-FLUX.1--dev-red)](https://huggingface.co/black-forest-labs/FLUX.1-dev) 🖌️ FLUX Text-to-Image Web UI Agent — ROCm-Ready | Created by J.R. \nEnter a prompt and press Generate.")
        ...
        with gr.Row():
            with gr.Column(scale=2):
                ...
                negative = gr.Textbox(label="✏️🚫 Negative prompt", value="", lines=2)
                model_id = gr.Textbox(label="🧠 Model (HF id)", value="black-forest-labs/FLUX.1-dev")
